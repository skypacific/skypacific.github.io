---
published: true
title: Vue-CLI를 사용해서 Vue.js 프로젝트를 생성하고 Vuetify 머터리얼 디자인 적용
categories: Spring
tags: [Front-end, Vue.js, Vuetify, Material Design, Vue-CLI]
layout: post
excerpt: Vue-CLI를 사용해서 Vue.js 프로젝트를 생성하고 Vuetify 머터리얼 디자인을 적용해 본다.
comments: yes
toc: true
---
...
* 기본적으로 생성되는 프로젝트에는 Vuetify 가 적용되지 으므로 터미널에서 아래 명령어로 Vuetify 를 적용한다.
```shell
$ vue add vuetify
```
...
![Vue-CLI 로 생성된 Vue.js 프로젝트 결과화면 #1](/assets/images/vuejs_project02.png)
...
* 웹브라우져에서 아래 주소로 접속하면 프로젝트 실행 결과 화면을 볼 수 있다.
![Vue-CLI 로 생성된 Vue.js 프로젝트 결과화면 #2](/assets/images/vuejs_project03.png)

### 5. 제품 데이타 추가

* script 영역의 date 아래의 "products" 배열값을 아래 내용으로 수정한다.
{% raw %}
```javascript
products: [
    {
...
* 웹브라우져에서 아래 주소로 접속하면 프로젝트 실행 결과 화면을 볼 수 있다.
![Vue-CLI 로 생성된 Vue.js 프로젝트 결과화면 #3](/assets/images/vuejs_project04.png)
...
![Vue-CLI 로 생성된 Vue.js 프로젝트 결과화면 #4](/assets/images/vuejs_project05.png)

***

본 예제 결과물 vueapp02.zip 소스파일은 아래 링크에서 다운받을 수 있다.  
<i class="nf nf-fa-archive"></i> [vueapp02.zip 소스파일]({{ "/assets/download/vueapp02.zip" | absolute_url }})
